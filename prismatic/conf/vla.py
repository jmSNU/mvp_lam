...
@dataclass
class Exp_DinoSigLIP_224px_OXE_Magic_Soup_VI(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-oxe-magic-soup-vi"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"

    data_mix: str = "omni_magic_soup_v2_vi" 
...
class VLARegistry(Enum):
    ...
    DINOSIGLIP_224PX_MX_OXE_MAGIC_SOUP_VI = Exp_DinoSigLIP_224px_OXE_Magic_Soup_VI
