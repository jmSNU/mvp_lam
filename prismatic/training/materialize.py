...
from prismatic.training.strategies import FSDPStrategy, TrainingStrategy, DeepSpeedZeRO3CPUOffloadStrategy, EvalStrategy
...
TRAIN_STRATEGIES = {
    ...
    "ds-zero3-cpuoffload": {"cls": DeepSpeedZeRO3CPUOffloadStrategy, "kwargs": {}},
}
