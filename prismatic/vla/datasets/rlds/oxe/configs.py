...
egoexo4d_config = {f"egoexo4d_split_{i}":egoexo4d_val for i in range(1, 53)}
...
OXE_DATASET_CONFIGS = {
    ...
    "bridge_rlds": {  
        "image_obs_keys": {"primary": "image_0", "secondary": "image_1", "wrist": "image_3"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", None, "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    ...
    "bridge_multiview": {  
        "image_obs_keys": {"primary": "image_0", "secondary": None, "wrist": "image_1"}, # image_1 is not genuine wrist view image, in general.
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", None, "gripper_state"],
        "state_encoding": StateEncoding.POS_EULER,
        "action_encoding": ActionEncoding.EEF_POS,
    ...
    "carrot": {
        "image_obs_keys": {"primary": "image", "ssecondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": [None, None, None, None, None, None, None, None],
...
OXE_DATASET_CONFIGS.update(egoexo4d_config)