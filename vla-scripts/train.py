...
class TrainConfig:
    ...
    # Tracking Parameters
    trackers: Tuple[str, ...] = ("wandb", "jsonl")                  # Trackers to initialize (if W&B, add config!)
...
def train(cfg: TrainConfig) -> None:
    ...
    overwatch.info(f"Loading latent action mode from `{cfg.lam_path}`")
    ...
    lam_ckpt = torch.load(cfg.lam_path, map_location="cpu")
    ...
    overwatch.info(f"Num added tokens : {num_added_toks}")
